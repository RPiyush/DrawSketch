...
//  FIMS
//
//  Created by Piyush Rathi on 24/01/17.
...
@objc protocol DrawSketchViewControllerDelegate{
    @objc optional func imageDrawnCompleted(imagePath:String);
}
...
class DrawSketchViewController: UIViewController, UIPopoverControllerDelegate, DrawSketchViewDelegate, DrawTextInputViewDelegate {
    ...
    weak var delegate:DrawSketchViewControllerDelegate?
    ...
    override func viewDidLoad() {
        ...
        self.setLayerToObject(objectLayer: self.drawButton.layer)
    ...
    @IBAction func onDrawButtonClicked(sender:AnyObject){
        ...
        self.drawButton?.setBackgroundImage(UIImage(named:DrawSketchStaticFields.overlayImage), for: .normal)
    ...
    @IBAction func onEraseButtonClicked(sender:AnyObject){
        ...
        self.drawButton?.setBackgroundImage(UIImage(named:""), for: .normal)
    ...
    @IBAction func on_NavSaveButtonClicked(sender:AnyObject){
        let imagePath = self.saveData()
        self.delegate?.imageDrawnCompleted!(imagePath: imagePath)
    ...
    @IBAction func onColorPickerButtonClicked(sender:AnyObject){
        ...
        let popoverVC = ColorPickerViewController(nibName: "ColorPickerViewController", bundle: nil)
